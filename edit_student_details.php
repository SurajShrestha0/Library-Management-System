                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                // Construct an SQL query to retrieve user information for the user with the matching User ID
                                ...
                                // Assign the user information to variables for use in the HTML code that follows
                                $name=$row['Name'];
                                ...
                                $pswd=$row['Password'];
                                ?>    
                    			<!-- Insert HTML code to display the user information here-->
...
{
    //Get user id from URL and user input from POST request to update user information
    $rollno = $_GET['id'];
    $name=$_POST['Name'];
