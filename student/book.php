            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <br>
                        <?php
                        // Checking if the form has been submitted and filtering search results
                        ...
                        // Executing SQL query and counting rows returned
                        $result = $conn->query($sql);
                        $rowcount = mysqli_num_rows($result);
                        // Displaying appropriate message based on number of rows returned
                        if (!($rowcount))
                            echo "<br><center><h2><b><i>No Results</i></b></h2></center>";
                        else {
                            // Displaying search results or all books
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center><a href="bookdetails.php?id=<?php echo $bookid; ?>" class="btn btn-primary">Details</a>
                                                    <?php
                                                    if ($avail > 0)
                                                        echo "<a href=\"time1.php?id=" . $bookid . "\" class=\"btn btn-success\">Issue</a>";
