...
?>
    ...
    <head>
        <!-- These lines of code are defining the structure and styling of the HTML page.-->
                    ...
                    <div class="span9">
                        <table class="table" id="tables">
                            ...
                            <tbody>
                                ...
                                /* `=['UserId'];` is assigning the value of the
                                    current user's ID (stored in the `UserId` session variable) to
                                    the variable ``. This variable is then used in the SQL
                                    query to retrieve messages specific to the current user. */
