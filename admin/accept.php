...
// Execute the SQL query using the connection object and store the result
 ...
 $sql5="insert into LMS.message (UserId,Msg,Date,Time) values ('$rollno','Your request for issue of BookId: $bookid  has been accepted',curdate(),curtime())";
...
{$sql2="update LMS.record set Date_of_Issue=curdate(),Due_Date=date_add(curdate(),interval 2 day),Renewals_left=1 where BookId='$bookid' and UserId='$rollno'";
...
{$sql4="update LMS.book set Availability=Availability-1 where BookId='$bookid'";
 ...
 //inset the value in message table
 $sql6="insert into LMS.message (UserId,Msg,Date,Time) values ('$rollno','Your request for issue of BookId: $bookid has been accepted',curdate(),curtime())";
