...
<html lang="en">
    ...
    <body>
        ...
        <!--/.wrapper-->
        <!-- /* These are script tags that are linking to various JavaScript files. These files are used to 
        add functionality and interactivity to the web page. */-->
...
<?php }
  ...
  /* This line of code is displaying an alert message with the text "Access Denied!!!" using
  JavaScript. It is being executed if the user does not have a valid session and is therefore denied
  access to the page. */
