                    ...
                    <div class="span9">
                        <table class="table" id="tables">
                            ...
                            <tbody>
                               ...
                               'Book_Name', 'Description', and 'UserId' from the current row of the
                               result set obtained from the SQL query. These values are then
                               assigned to the variables , , and 
                               respectively. These variables are then used to display the data in
                               the HTML table. */
                        ...
                        <center>
                            <!-- addbook file upload -->
                            <a href="addbook.php" class="btnp btn-success">Add a Book</a>
                        </center>
                    </div>
                    <!--/.span9-->
                </div>
