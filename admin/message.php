                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="message.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="UserId"><b>Receiver Roll No:</b></label>
                                            <div class="controls">
                                                <input type="text" id="UserId" name="UserId" placeholder="UserId" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
...
{//assigns the values of two variables
    $rollno=$_POST['UserId'];
    $message=$_POST['Message'];
//insert the value in message database table
$sql1="insert into LMS.message (UserId,Msg,Date,Time) values ('$rollno','$message',curdate(),curtime())";
//check connection 
...
<?php }
else {//display access denied message
