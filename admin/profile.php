...
{
    //handling form data submitted via HTTP POST request and assigning  values fields to variables storage in a database.
    $rollno = $_GET['id'];
    $name=$_POST['Name'];
    $email=$_POST['EmailId'];
    $mobno=$_POST['MobNo'];
    $pswd=$_POST['Password'];
//update user table on the base of user id.
