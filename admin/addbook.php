                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="addbook.php" method="post">
                                        ...
                                        <div class="control-group">
                                            ...
                                            for="Availability"><b>Number of Copies</b></label>
                                            <div class="controls">
...
<?php
//Check submit button was clicked in html form
if(isset($_POST['submit']))
{
    //Retrieve book data from the form's input fields
    $title=$_POST['title'];//title name
    $author1=$_POST['author1'];//author name
    $author2=$_POST['author2'];
    $author3=$_POST['author3'];
    $publisher=$_POST['publisher'];//publisher 
    $year=$_POST['year'];//year 
    $availability=$_POST['availability'];
 // Construct an SQL INSERT statement to add the book data to the 'book' table in the LMS database
$sql1="insert into LMS.book (Title,Publisher,Year,Availability) values ('$title','$publisher','$year','$availability')";
 // Execute the SQL INSERT statement and check if it was successful
if($conn->query($sql1) === TRUE){
// Retrieve the maximum book ID from the 'book' table using a SELECT statement and store it in variable $x
$sql2="select max(BookId) as x from LMS.book";
$result=$conn->query($sql2);
$row=$result->fetch_assoc();
$x=$row['x'];
// Construct and execute additional SQL INSERT statements to add the author data (up to three authors) to the 'author' table, using the $x value as the book ID for each author
...
<?php }
else {//Display Access Denied alert message
