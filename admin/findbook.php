...
<?php }
 ...
 /* Displaying an alert message with the text "Access Denied!!!" using JavaScript. This code is
 executed if the user is not logged in and tries to access the page. */
