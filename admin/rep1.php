                ...
                <div class="row">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        if (empty($userid)) {
                            ...
                            $sql = "SELECT * FROM LMS.user WHERE UserId='$userid'";
                            $result = $conn->query($sql);

                            if ($result->num_rows > 0) {
                                // User ID exists, redirect to the page to display data
                                header("Location: reportGen.php?userid=$userid");
                                ob_end_flush();
                            } else {
                                // User ID doesn't exist, show error message
